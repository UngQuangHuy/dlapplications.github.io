...
Transfer Learning cũng được sử dụng rất nhiều trong Natural Language Processing (NLP). Trên thực tế thì: nếu CV dùng Convolutional Network để trích xuất các features từ ảnh thì NLP dùng Word Embeddings như một cách để trích xuất các features từ các từ thành những vectors. Hiệu quả thực tiễn của Word Embeddings [cao hơn](https://www.datacamp.com/community/tutorials/lda2vec-topic-model) hẳn one-hot encodings về khả năng biểu diễn thông tin.
